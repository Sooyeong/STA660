...
# HR
#hr_aov <- aov(`avg HR` ~ Bike, data=averages)
#hr_aov
...
#%VO2 Max
#vo2_aov <- aov(`%of VO2max` ~ Bike, data=averages)
#vo2_aov
...
#RPE
rpe_aov <- aov(`RPE` ~ Bike, data=averages)
rpe_aov
...
#RF
rf_aov <- aov(`Rf` ~ Bike, data=averages)
rf_aov
...
#RQ
rq_aov <- aov(`RQ` ~ Bike, data=averages)
rq_aov
...
#EEm
eem_aov <- aov(`EEm` ~ Bike, data=averages)
eem_aov
...
#time
time_aov <- aov(`RPE` ~ Bike, data=averages)
time_aov
